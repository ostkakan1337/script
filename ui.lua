...
function library:CreateWindow(options, ...)
	...
	if windowName and #windowName > 0 and library.WorkspaceName == "Theos Lib" then
		library.WorkspaceName = convertfilename(windowName, "Theos Lib")
	end
