                ...
                if ScreenMin and ScreenMax then
                    ...
                    if ESP.Drawing.Boxes.Enabled then
                        if ESP.BoxStyle == "Full" then
                            ...
                            CornerOutlinesOuter[3].To = Vector2.new(BoxPosition.X + BoxSize.X - cornerSize - 1, BoxPosition.Y - 1)
                            CornerOutlinesOuter[4].From = Vector2.new(BoxPosition.X + BoxSize.X + 1, BoxPosition.Y - 1)
                            CornerOutlinesOuter[4].To = Vector2.new(BoxPosition.X + BoxSize.X + 1, BoxPosition.Y + cornerSize + 1)
                            
                            --// Bottom Left Corner
                            CornerOutlinesOuter[5].From = Vector2.new(BoxPosition.X - 1, BoxPosition.Y + BoxSize.Y + 1)
                            CornerOutlinesOuter[5].To = Vector2.new(BoxPosition.X + cornerSize + 1, BoxPosition.Y + BoxSize.Y + 1)
                            CornerOutlinesOuter[6].From = Vector2.new(BoxPosition.X - 1, BoxPosition.Y + BoxSize.Y + 1)
                            CornerOutlinesOuter[6].To = Vector2.new(BoxPosition.X - 1, BoxPosition.Y + BoxSize.Y - cornerSize - 1)
                            
                            --// Bottom Right Corner
                            CornerOutlinesOuter[7].From = Vector2.new(BoxPosition.X + BoxSize.X + 1, BoxPosition.Y + BoxSize.Y + 1)
                            CornerOutlinesOuter[7].To = Vector2.new(BoxPosition.X + BoxSize.X - cornerSize - 1, BoxPosition.Y + BoxSize.Y + 1)
                            CornerOutlinesOuter[8].From = Vector2.new(BoxPosition.X + BoxSize.X + 1, BoxPosition.Y + BoxSize.Y + 1)
                            CornerOutlinesOuter[8].To = Vector2.new(BoxPosition.X + BoxSize.X + 1, BoxPosition.Y + BoxSize.Y - cornerSize - 1)
                            ...
                            CornerOutlinesInner[3].To = Vector2.new(BoxPosition.X + BoxSize.X - cornerSize + 1, BoxPosition.Y + 1)
                            CornerOutlinesInner[4].From = Vector2.new(BoxPosition.X + BoxSize.X - 1, BoxPosition.Y + 1)
                            CornerOutlinesInner[4].To = Vector2.new(BoxPosition.X + BoxSize.X - 1, BoxPosition.Y + cornerSize - 1)
                            
                            --// Bottom Left Corner
                            CornerOutlinesInner[5].From = Vector2.new(BoxPosition.X + 1, BoxPosition.Y + BoxSize.Y - 1)
                            CornerOutlinesInner[5].To = Vector2.new(BoxPosition.X + cornerSize - 1, BoxPosition.Y + BoxSize.Y - 1)
                            CornerOutlinesInner[6].From = Vector2.new(BoxPosition.X + 1, BoxPosition.Y + BoxSize.Y - 1)
                            CornerOutlinesInner[6].To = Vector2.new(BoxPosition.X + 1, BoxPosition.Y + BoxSize.Y - cornerSize + 1)
                            
                            --// Bottom Right Corner
                            CornerOutlinesInner[7].From = Vector2.new(BoxPosition.X + BoxSize.X - 1, BoxPosition.Y + BoxSize.Y - 1)
                            CornerOutlinesInner[7].To = Vector2.new(BoxPosition.X + BoxSize.X - cornerSize + 1, BoxPosition.Y + BoxSize.Y - 1)
                            CornerOutlinesInner[8].From = Vector2.new(BoxPosition.X + BoxSize.X - 1, BoxPosition.Y + BoxSize.Y - 1)
                            CornerOutlinesInner[8].To = Vector2.new(BoxPosition.X + BoxSize.X - 1, BoxPosition.Y + BoxSize.Y - cornerSize + 1)
                            ...
                            Corners[7].To = Vector2.new(BoxPosition.X + BoxSize.X - cornerSize, BoxPosition.Y + BoxSize.Y)
